...
//     const newWindow = window.open('farmers.html');
    
//     // Wait until the new window has loaded before passing data
//     newWindow.addEventListener('load', () => {
//         newWindow.localStorage.setItem('farmersData', JSON.stringify(farmers));
//     });
// }
